        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <h1 class="text-center">Servicios estudiantiles</h1>
                    <div>
                        <form method="post" action="{{ route('listaS.update', $servicioid->idS) }}">
                            @csrf
                            {!! method_field('PUT')!!}
                    <div class="mb-3">
                        <label class="form-label text-center text-dark" name="labelServi">Servicio: </label>
                        <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" name="txtServe" value="{{$servicioid->servicio}}">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" name="txtStatus" value="{{$servicioid->estatus}}">
                            <option disabled selected>Selecciona una opción</option>
