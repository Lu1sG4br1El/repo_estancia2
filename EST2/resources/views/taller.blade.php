        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <form method="post" action="{{ route('listaT.store') }}">
                            @csrf
                    <div class="mb-3">
                        <label class="form-label text-center text-dark" name="labelTaller">Taller: </label>
                        <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" name="txtTaller" value="{{old('txtTaller')}}">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" name="txtDocente" value="{{old('txtDocente')}}">
                            <option disabled selected>Selecciona una opción</option>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" name="txtHdE" value="{{old('txtHdE')}}">
                            <option disabled selected>Selecciona una opción</option>
